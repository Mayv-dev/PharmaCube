...
// src/pages/Regimes.tsx
import { IonContent, IonPage, IonButton } from '@ionic/react';
import LowerToolbar from '../components/LowerToolbar';
import '../styles/Regimes.css';
import { useHistory } from 'react-router-dom';

const Regimes: React.FC = () => {
  ...
  return (
    <IonPage>
      ...
      <IonContent className="regimes-content">
        <h2 className="title">Regimes</h2>
        
        <IonButton className="custom-button" onClick={() => history.push('/add-patient-regime')}>
          Add To Patient Regime
        </IonButton>
        
        <IonButton className="custom-button" onClick={() => history.push('/view-patient-regimes')}>
          View Patient Regimes
        </IonButton>
      </IonContent>
    </IonPage>
  );
